...
namespace Atlassian.Jira.Remote
{
    internal class IssueFilterService : IIssueFilterService
    {
        ...
        public async Task<IPagedQueryResult<Issue>> GetIssuesFromFavoriteAsync(string filterName, int? maxIssues = default, int startAt = 0, CancellationToken token = default)
        {
